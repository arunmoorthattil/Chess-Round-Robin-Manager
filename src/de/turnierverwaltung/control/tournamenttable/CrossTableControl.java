...
public class CrossTableControl {
	...
	public void makeSimpleTableView(final int gruppenNummer) {
		...
		simpleTableView[gruppenNummer].getStatusLabel().setText(Integer.toString(changedPartien.size()));
	}
	...
	public void updateStatus() {
		final int anzahlGruppen = mainControl.getTournament().getAnzahlGruppen();
		for (int i = 0; i < anzahlGruppen; i++) {
			simpleTableView[i].getStatusLabel().setText(Integer.toString(changedPartien.size()));
